...
%     metric = area2/area1;
% 
%     metric_string = sprintf('Not a cookie =(');
% 
%     if metric > threshold
%         count = count + 1;
%         centroid = stats(k).Centroid;
%         plot(centroid(1), centroid(2), 'ko');
%         metric_string = 'Cookie!'
%     end
% 
%     text(boundary(1, 2) - 35, boundary(1, 1) + 1000, metric_string, 'Color', 'black', 'FontSize', 14, 'FontWeight', 'bold');
% end
